...
- Published the AI Metadata Cleaner Codex skill as a self-contained local
  package with its CLI runtime, tests, documentation, and Windows bootstrap.
- Added verified `ai-clean` processing for embedded image metadata and AI
  provenance fields while preserving originals and adjacent sidecars.
- Kept the upstream MIT attribution and documented derived-work ownership in
